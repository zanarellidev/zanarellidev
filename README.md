...
- [klauspost/compress](https://github.com/klauspost/compress/pull/1182) — correção de race condition em dicionário compartilhado no zstd.
- [klauspost/compress](https://github.com/klauspost/compress/pull/1183) — GitHub Action do OpenSSF Scorecard.
- [klauspost/compress](https://github.com/klauspost/compress/pull/1184) — correção de offsets inválidos no `BuildDict` do zstd.
